  ...
  return (
    ...
    ref={fadeInRef}>
      <section className='aboutSection'>
        <a href='https://www.linkedin.com/in/isaac-ruiz-6996b3231/' className='portraitPhotoContainer'><img className='portraitPhoto' src='https://i.ibb.co/k6z3kzv/portrait.jpg'/></a>
